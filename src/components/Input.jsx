...
const InputMsg = ({ placeholder, textColor, onChange, value }) => {
  return (
    <>
...
const InputComponent = ({ type, placeholder, onChange, value }) => {
  ...
  return (
    <>
      {type === "name" ? (
        <InputName onChange={onChange} placeholder={placeholder} textColor={textColor} value={value} />
      ) : type === "email" ? (
        <InputEmail onChange={onChange} placeholder={placeholder} textColor={textColor} value={value} />
      ) : type === "messages" ? (
